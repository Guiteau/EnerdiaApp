...
public class GeneracionRenovable extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_showBottomResult.setText("GENERACIÓN RENOVABLE \n\n" + "0 MW");
        ...
        spinner_hora_inicio.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!editTextDate_fin.getText().toString().matches("") && !editTextDate_inicio.getText().toString().matches("")){
                    ...
                    Call<PeticionGeneracionRenovable> peticionGeneracionRenovable = apiService.generacionTiempoRealRenovable(String.valueOf(anio_inicio) + "-" +
                    ...
                    peticionGeneracionRenovable.enqueue(new Callback<PeticionGeneracionRenovable>() {

                        @Override
                        public void onResponse
                                (Call<PeticionGeneracionRenovable> call, Response<PeticionGeneracionRenovable> response) {
                            ...
                            if (response.code() == HttpURLConnection.HTTP_OK) {
                                ...
                                if(list_valorRespuesta.size() == 0){
                                    ...
                                    Toast.makeText(GeneracionRenovable.this, "No hay datos disponibles para esas fechas", Toast.LENGTH_SHORT).show();
                        ...
                        @Override
                        public void onFailure(Call<PeticionGeneracionRenovable> call, Throwable t) {

                            Toast.makeText(GeneracionRenovable.this, "Error en la petición. El mercado diario genera grandes cantidades de datos. Procura elegir franjas cortas de tiempo",
                ...
                if(!editTextDate_fin.getText().toString().matches("") && !editTextDate_inicio.getText().toString().matches("")){
                    ...
                    peticionGeneracionRenovable.enqueue(new Callback<PeticionGeneracionRenovable>() {
                        ...
                        public void onFailure(Call<PeticionGeneracionRenovable> call, Throwable t) {
                            ...
                            Toast.makeText(GeneracionRenovable.this, "Error en la petición. El mercado diario genera grandes cantidades de datos. Procura elegir franjas cortas de tiempo", Toast.LENGTH_SHORT).show();
                        ...
                        peticionGeneracionRenovable.enqueue(new Callback<PeticionGeneracionRenovable>() {
                            ...
                            public void onResponse
                                ...
                                if (response.code() == HttpURLConnection.HTTP_OK) {
                                    ...
                                    if(list_valorRespuesta.isEmpty()){
