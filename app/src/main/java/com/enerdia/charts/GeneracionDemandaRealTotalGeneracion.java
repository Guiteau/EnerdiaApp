...
public class GeneracionDemandaRealTotalGeneracion extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_showBottomResult.setText("DEMANDA REAL SUMA TOTAL GENERACIÓN \n\n" + "0 MW");
        ...
        spinner_hora_inicio.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!editTextDate_fin.getText().toString().matches("") && !editTextDate_inicio.getText().toString().matches("")){
                    ...
                    Call<PeticionGeneracionDemandaRealTotalGeneracion> peticionGeneracionDemandaRealTotalGeneracion = apiService.demandaRealSumaGeneracion(String.valueOf(anio_inicio) + "-" +
                    ...
                    peticionGeneracionDemandaRealTotalGeneracion.enqueue(new Callback<PeticionGeneracionDemandaRealTotalGeneracion>() {

                        @Override
                        public void onResponse
                                (Call<PeticionGeneracionDemandaRealTotalGeneracion> call, Response<PeticionGeneracionDemandaRealTotalGeneracion> response) {
                            ...
                            if (response.code() == HttpURLConnection.HTTP_OK) {
                                ...
                                if(list_valorRespuesta.size() == 0){
                                    ...
                                    Toast.makeText(GeneracionDemandaRealTotalGeneracion.this, "No hay datos disponibles para esas fechas", Toast.LENGTH_SHORT).show();
                        ...
                        @Override
                        public void onFailure(Call<PeticionGeneracionDemandaRealTotalGeneracion> call, Throwable t) {

                            Toast.makeText(GeneracionDemandaRealTotalGeneracion.this, "Error en la petición. El mercado diario genera grandes cantidades de datos. Procura elegir franjas cortas de tiempo", Toast.LENGTH_SHORT).show();
