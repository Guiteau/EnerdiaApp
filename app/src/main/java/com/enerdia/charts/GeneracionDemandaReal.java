...
public class GeneracionDemandaReal extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_showBottomResult.setText("DEMANDA REAL \n\n" + "0 €/MWh");
        ...
        spinner_hora_inicio.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!editTextDate_fin.getText().toString().matches("") && !editTextDate_inicio.getText().toString().matches("")){
                    ...
                    Call<PeticionGeneracionDemandaReal> peticionGeneracionDemandaReal = apiService.demandaReal(String.valueOf(anio_inicio) + "-" +
                    ...
                    peticionGeneracionDemandaReal.enqueue(new Callback<PeticionGeneracionDemandaReal>() {

                        @Override
                        public void onResponse
                                (Call<PeticionGeneracionDemandaReal> call, Response<PeticionGeneracionDemandaReal> response) {
                            ...
                            if (response.code() == HttpURLConnection.HTTP_OK) {
                                ...
                                if(list_valorRespuesta.size() == 0){
                                    ...
                                    Toast.makeText(GeneracionDemandaReal.this, "No hay datos disponibles para esas fechas", Toast.LENGTH_SHORT).show();
                        ...
                        @Override
                        public void onFailure(Call<PeticionGeneracionDemandaReal> call, Throwable t) {

                            Toast.makeText(GeneracionDemandaReal.this, "Error en la petición. El mercado diario genera grandes cantidades de datos. Procura elegir franjas cortas de tiempo", Toast.LENGTH_SHORT).show();
