...
public class PrecioMedioDiario extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] minutosInicioString = {"00"};
    private String[] minutosFinString = {"50"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.precio_medio_diario);
        ...
        textView_showBottomResult.setText("PRECIO MEDIO DIARIO \n\n" + "0 €/MWh");
        ...
        spinner_minuto_inicio.setEnabled(false);
        spinner_minuto_inicio.setClickable(false);
        ...
        spinner_minuto_fin.setEnabled(false);
        spinner_minuto_fin.setClickable(false);
        ...
        spinner_hora_inicio.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               ...
               if(!editTextDate_fin.getText().toString().matches("") && !editTextDate_inicio.getText().toString().matches("")){
                   ...
                   Call<PeticionPrecioMedioDiario> peticionPrecioMedioDiario = apiService.precioMedioDiario(String.valueOf(anio_inicio) + "-" +
                                   String.valueOf(mes_inicio) + "-" + String.valueOf(dia_inicio) + "T" + String.valueOf(hora_inicio) + ":00:00Z",
                           String.valueOf(anio_fin) + "-" + String.valueOf(mes_fin) + "-" + String.valueOf(dia_fin) + "T" + String.valueOf(hora_fin) + ":50:00Z",
                           "Token token=" + token);

                   peticionPrecioMedioDiario.enqueue(new Callback<PeticionPrecioMedioDiario>() {

                       @Override
                       public void onResponse
                               (Call<PeticionPrecioMedioDiario> call, Response<PeticionPrecioMedioDiario> response) {
                       ...
                       @Override
                       public void onFailure(Call<PeticionPrecioMedioDiario> call, Throwable t) {

                           Toast.makeText(PrecioMedioDiario.this, "Error en la petición. El mercado diario genera grandes cantidades de datos. Procura elegir franjas cortas de tiempo", Toast.LENGTH_SHORT).show();
